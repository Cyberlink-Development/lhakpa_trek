            ...
            @if ($banner->count() > 0)
                @foreach ($banner as $row)
                    <div class="row" id="banner-rec-{{ $loop->iteration }}">
                        ...
                        {{-- <div class="col-md-1">
                            <input type="number" min="1" max="2000" name="banner_ordering[]" value="{{ $row->ordering }}" class="form-control" placeholder="" />
                        </div>
                        <div class="col-md-3">
                            <input type="text" name="banner_title[]" value="{{ $row->title }}" class="form-control" placeholder="" />
                        </div> --}}
                        <!--<div class="col-md-4">-->
                        ...
                        <div class="col-md-10">
                            <textarea class="my-editor form-control" name="banner_content[]" value="{{ $row->content }}" placeholder="">{{ $row->content }}</textarea>
                        </div>

                        <div class="col-md-1"><button class="btn btn-danger delete-banner" banner-rowid="{{ $row->id }}" banner-data-id="{{ $loop->iteration }}"><i class="glyphicon glyphicon-trash"></i></button></div>
                    </div>
                @endforeach
            @endif
        </div>
        ...
        <div style="display:none;">
            <div id="row_banner_additional">
                <div class="row">
                    ...
                    {{-- <div class="col-md-1"><input type="number" min="1" max="2000" name="banner_ordering[]" class="form-control" placeholder="" /></div>
                    <div class="col-md-3"><input type="text" name="banner_title[]" class="form-control" placeholder="" />
                    </div>
                    <div class="col-md-2"><input type="text" name="banner_content[]" class="form-control" placeholder="" /></div>
